      ...
      <Row className="centered-row" gutter={[16, 16]}>
        <Col xs={24} sm={16} md={12} className="text-column">
          ...
          <p className="largetext-express">
            Satin clothing labels are the ideal material for soft care labels
            that include laundry instructions and material content information.
            Printed satin labels are found on almost all garments sold in the
            USA as required by the FTC. Satin clothing labels are used to ensure
            consumers are informed of the quality of materials used and country
            of origin. In addition, when accurate care label laundry
            instructions are followed, they help extend the life of the garment.
          </p>
          <p className="largetext-express">
