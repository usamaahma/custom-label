      ...
      <Row className="centered-row" gutter={[16, 16]}>
        <Col xs={24} sm={16} md={12} className="text-column">
          ...
          <p className="largetext-express">
            These fast delivery clothing labels include the industry's quickest
            3-day turnaround time for customized fabric clothing labels. Express
            clothing labels are guaranteed to ship within 3 business days of
            receiving your digital proof approval. These custom woven labels are
            made in the USA and use a dye-sublimation printing process for
            unlimited colors. Your design is imprinted onto our premium woven
            label material and cut to size with an ultrasonic knife for soft
            edges that won't fray.
          </p>
          <p className="largetext-express">
            Upload artwork and select your options below. Our team will help
            finalize your express clothing label design and send you a digital
