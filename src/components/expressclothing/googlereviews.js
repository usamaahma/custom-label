  ...
  const reviews = [
    {
      ...
      review:
        "Great service and fast delivery. The quality of the product exceeded my expectations. Highly recommend!",
    },
    {
      name: "John Doe",
    ...
    },
    {
      ...
      rate: <Rate disabled defaultValue={5} />,
      review:
        "The labels are top-notch. Customer service was also fantastic. Will definitely order again!",
    },
  ];
