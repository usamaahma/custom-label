                ...
                <Col xs={24} md={16} className="left-column">
                    ...
                    <div>
                        ...
                        <div className='divs-tableexpress'>
                            ...
                            >
                                <img alt='abc' src='../images/straight.png' className='image-card-express' />
                                <p>STANDARD:15 <br />Business Days</p>
                            </Card>
                            <Card
                                bordered={false}
                                style={{
...
export default Screenprintedtable;
