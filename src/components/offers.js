            ...
            <Row gutter={[16, 16]} justify="center">
                {seoTopics.map((topic, index) => (
                    <Col xs={24} sm={12} md={8} key={index}>
                        ...
                        <Bounce cascade><img src={topic.ImageUrl} alt={topic.title} className="card-icon" /></Bounce>
                            <h3>{topic.title}</h3>
