    ...
    <Form className="fancyform-main">
      ...
      <Row gutter={16}>
        <Col xs={24} sm={12}>
          ...
          <Form.Item   className="custom-input-form">
            <Select placeholder="Select Paper Weight" className="custom-input-fancy">
          ...
          <Form.Item   className="custom-input-form">
            <Select placeholder="Select Paper Finish" className="custom-input-fancy">
          ...
          <Form.Item   className="custom-input-form">
            <Select placeholder="Select Print Option" className="custom-input-fancy">
          ...
          <Form.Item   className="custom-input-form">
            <Select placeholder="Select Position" className="custom-input-fancy">
          ...
          <Form.Item   className="custom-input-form">
            <Input.TextArea className="custom-input-fancy" placeholder="Enter any comments here" />
          </Form.Item>
          <p className="txt-fancy-bold">Quantity</p>
          <Form.Item   className="custom-input-form">
            <Input type="number" className="custom-input-fancy" placeholder="Enter quantity" />
          </Form.Item>
        </Col>
        ...
        <p className="txt-fancy-bold">Name</p>
          <Form.Item   className="custom-input-form">
            <Input placeholder="Enter your name" className="custom-input-fancy"/>
          </Form.Item>
          <p className="txt-fancy-bold">Email</p>
          <Form.Item   className="custom-input-form">
            <Input type="email" placeholder="Enter your email" className="custom-input-fancy"/>
          </Form.Item>
          <p className="txt-fancy-bold">Phone Number</p>
          <Form.Item   className="custom-input-form">
            <Input placeholder="Enter your phone number" className="custom-input-fancy"/>
          </Form.Item>
          ...
          <p className="txt-fancy-endline">After submitting, we will email you a custom price quote within<br></br> 2 business days.</p>
        </Col>
      </Row>
    </Form>
  );
