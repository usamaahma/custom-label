      ...
      <Row className="centered-row" gutter={[16, 16]}>
        <Col xs={24} sm={16} md={12} className="text-column">
          ...
          <p className="largetext-express">
            Custom sublimation labels utilize a dye-sublimation print to
            translate designs with complex color blends or photographic details
            onto your clothing labels. The results are impressive and allow us
            to produce clothing label designs not possible with traditional
            woven labels. Sublimation labels use our soft woven label material.{" "}
          </p>
          <p className="largetext-express">
            Any special instructions not included in your artwork file can be
            included in the comment section below. You will receive a digital
            proof for final approval within 1 business day of placing your
            order. An expert staff member will be assigned to your order in case
          ...
          <div className="hero-firstdiv">
            <div>
              <ul className="list-express">
                ...
                <li>Size versions available (s, m, l, xl)</li>
                <li>Sew-on, Iron-on or Peel & Stick</li>
