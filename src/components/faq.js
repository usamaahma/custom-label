...
const Faq1 = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "No! Your order includes free graphic artwork and unlimited revisions. You will receive a free digital proof for approval within 1 business day of placing your order. The pricing on our website is complete, only add shipping. Sales tax only applies to orders shipped within NY."
        },
        {
            question: "Will I be able to see what my label will look like before proceeding with my full order?",
            answer: "Yes! All custom orders receive a free digital proof for approval within 1 business day. You will be able to review your exact label specifications and make any changes if necessary before we manufacture the full order."
        },
        {
            question: "What is the minimum quantity I can order?",
            answer: "We offer the industry’s lowest minimum order quantity of just 5 pieces for most products. Select products such as leather patches and pvc patches have a higher minimum quantity due to the setup costs associated with those products."
        }
