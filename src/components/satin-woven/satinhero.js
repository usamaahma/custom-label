      ...
      <Row className="centered-row" gutter={[16, 16]}>
        <Col xs={24} sm={16} md={12} className="text-column">
          ...
          <p className="largetext-express">
            Woven satin clothing labels have a luxurious look and heavier feel
            compared with standard woven labels. Design elements are slightly
            raised off the surface of the background material, lending them the
            look of embroidered clothing labels. If you're looking for
            embroidered labels for clothing, woven satin clothing labels are a
            good choice. Traditional applications include bridal wear, suits and
            other formal garments.
          </p>
          <p className="largetext-express">
            Upload artwork and select your options below. Our team will help
            finalize your woven satin clothing label and send you a digital
