      ...
      <Row className="centered-row" gutter={[16, 16]}>
        <Col xs={24} sm={16} md={12} className="text-column">
          ...
          <p className="largetext-express">
            No artwork file? Not a problem. Our simple design tool allows you to
            easily create personalized name labels for clothing. These name
            labels for clothes are high quality and affordable, starting at only
            $18. Design your basic woven clothing labels with two thread colors
            and up to two lines of text. Three size options are also available.
            Name labels for clothing also allow you to approve your design
            before checkout, saving time and allowing your order to go directly
            into production. All woven text labels are manufactured individually
            and ship within 15 business days of placing your order.
          </p>
          <div className="hero-firstdiv">
            <div>
              <ul className="list-express">
                <li>Online design tool</li>
                <li>No artwork file required</li>
                <li>Instant digital proof approval</li>
                <li>2 colors & 2 lines of text</li>
            ...
            <div className="second-firstdiv">
              ...
              <ol className="order-list">
                ...
                <li>
                  See your Ship Date and track your order progress from your
                  customer account.
                </li>
              </ol>
            </div>
