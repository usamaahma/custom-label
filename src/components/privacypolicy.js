...
function Privacypolicy1() {
  return (
    <div className="privacy-policy-container">
      <h1 className="policy-heading">Privacy Policy</h1>
      <div className="privacy-p">
        Quality Woven Labels is committed to ensuring that your privacy is
        ...
        Quality Woven Labels may change this policy from time to time by
        updating this page. You should check this page from time to time to
        ensure that you are happy with any changes.
      </div>
      <h2 className="policy-subheading">What we collect</h2>
      <div className="privacy-p">We may collect the following information:</div>
      <ul className="privacy-ul">
        <li className="privacy-li">name</li>
        <li className="privacy-li">contact information including email address</li>
        <li className="privacy-li">demographic information such as postcode, preferences, and interests</li>
        <li className="privacy-li">other information relevant to customer surveys and/or offers</li>
        <li className="privacy-li">your IP address</li>
      </ul>
      <div className="privacy-p">
        For the exhaustive list of cookies we collect see the List of cookies
        we collect section.
      </div>
      <h2 className="policy-subheading">What we do with the information we gather</h2>
      <div className="privacy-p">
      ...
      <ul className="privacy-ul">
        <li className="privacy-li">Internal record keeping.</li>
        <li className="privacy-li">We may use the information to improve our products and services.</li>
        <li className="privacy-li">We may periodically send promotional emails about new products, special offers, or other information that we think you may find interesting using the email address you have provided.</li>
        <li className="privacy-li">We may also use your information to contact you regarding any quotations placed through our website.</li>
        <li className="privacy-li">We may contact you by email, phone, fax, or mail.</li>
      </ul>
      <h2 className="policy-subheading">Security</h2>
      <div className="privacy-p">
      ...
      <h2 className="policy-subheading">How we use cookies</h2>
      <div className="privacy-p">
      ...
      <h2 className="policy-subheading">Links to other websites</h2>
      <div className="privacy-p">
      ...
      <h2 className="policy-subheading">Controlling your personal information</h2>
      <div className="privacy-p">
      ...
      <ul className="privacy-ul">
        ...
        <li className="privacy-li">
          ...
          <a href="mailto:sales@qualitywovenlabels.com">
            sales@qualitywovenlabels.com
          </a>
          .
        </li>
      </ul>
      <div className="privacy-p">
        ...
        third parties unless we are required by law to do so. You may request
        ...
        copy of the information held on you please write to 1760 Glasco
        Turnpike Woodstock, NY 12498. 
        <div className="privacy-p">
      ...
      <h2 className="policy-subheading">Return Policy</h2>
      <div className="privacy-p">
        Returns will be accepted within 30 days of receiving your order. You
        are responsible for return shipping if your labels match your Digital
        Proof. If your labels do not match your Digital Proof we will pay the
        return shipping and send a call tag. Your refund will be processed
        within 48 hours of receiving your return. If you have paid by credit
        card, your refund will be credited back to your card. Paypal orders
        will receive a PayPal refund. Orders paid for by e-check will have
        their bank account credited.
      </div>
    </div>
  );
}
