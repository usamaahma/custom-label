  ...
  return (
    <div className="privacy-policy-container">
      ...
      <ul>
        ...
        <li>We may periodically send promotional emails about new products, special offers, or other information that we think you may find interesting using the email address you have provided.</li>
        <li>We may also use your information to contact you regarding any quotations placed through our website.</li>
      ...
      <p>
        ...
        and then the data is removed from the system.<p>Overall, cookies help us
      ...
      <p>
        ...
        Turnpike Woodstock, NY 12498. <p>If you believe that any information we
        ...
        correct any information found to be incorrect.</p>
      </p>
