...
const cardData4 = [
    { id: 1, imgSrc: "../images/colorversion.png", title: "Yes, I Need Versions" },
    { id: 2, imgSrc: "../images/colorversion.png", title: "Yes, I Need Versions" },
  ];
 const cardData7 = [
          ...
          <Row className="simpletable-centered-row-table">
            <Col xs={24} md={16} className="simpletable-left-column">
              ...
              <div>
                ...
                {/* 4 */}
                <div className="size-txt">
                  <h2 className="simpletable-heading">Size Symbols or Color Versions</h2>
                </div>
