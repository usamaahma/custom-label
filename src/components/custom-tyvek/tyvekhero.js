      ...
      <Row className="centered-row" gutter={[16, 16]}>
        <Col xs={24} sm={16} md={12} className="text-column">
          ...
          <p className="largetext-express">
            Tyvek labels are commonly used as mattress care labels or furniture
            warning labels. Mattress care labels require tear-resistance and the
            ability to print fine instructions and symbols, making our white
            Tyvek material the ideal solution. Our custom Tyvek labels are
            screen printed and can include up to 4 print colors.
          </p>
          <p className="largetext-express">
            Upload artwork and select your options below. Our team will help
            finalize your Tyvek label design and send you a digital proof for
